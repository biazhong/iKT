...
public class mainAmbulance {
	public static void main(String[] args) {
		...
		int seed =  53457; //Pseudo random number seed used to conduct the experiment.
		int sp = 250;
		int ep = 500;
		...
		for(int count = 0; count<repeat; count++) {
			...
			//KT3Ambulance y = new KT3Ambulance(sp,ep,muCall,muServe,alpha,delta,altVec,seedInOneReplication,n0Prime);
			...
			System.out.println(count+" "+selected+" "+altVec[selected][0]+" "+altVec[selected][1]
					+" "+altVec[selected][2]+" "+altVec[selected][3]+" "
					+altVec[selected][4]+" "+altVec[selected][5]+" "
					+altVec[selected][6]+" "+altVec[selected][7]+" "
					+altVec[selected][8]+" "+y.getSampleSize()+" "+run_time);
		}
