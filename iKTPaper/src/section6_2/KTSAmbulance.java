...
public class KTSAmbulance {
	...
	public KTSAmbulance(int sp, int ep,double muCall, double muServe,
	...
	public void run() {
		...
		//	for(int i = 0; i < I.size(); i++) {
			//	System.out.print(" "+i+" "+I.get(i)+" "+frakX[I.get(i)]/T[I.get(i)]+" ");
