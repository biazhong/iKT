...
public class mainAmbulance {
	public static void main(String[] args) {
		...
		int seed =  345122; //Pseudo random number seed used to conduct the experiment.
		int sp = 250;
		int ep = 500;
		...
		for(int count = 0; count<repeat; count++) {
			...
			System.out.println(count+" "+selected+" "+y.getSampleSize()+" "+altVec[selected][0]+" "+altVec[selected][1]
