...
public class iKTPGSAmbulance {
	...
	public iKTPGSAmbulance(int sp, int ep,double muCall, double muServe,
		...
		while(I.size()>1) {
			...
			for(int i = 0;  i < numOfMatches; i++) {
				if(i < numOfMatches - 1) {
					...
					tAmbulance y = new tAmbulance(sp,ep,muCall,muServe,alpha_r,delta,groupAltVec,R.nextInt(),n0Prime);
			...
			System.out.println(I.size()+" "+sampleSize);
		}
		bestID=I.get(0);
	}
