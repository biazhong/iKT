...
public class main {
	public static void main(String[] args) {
		int k = 2000;			//Number of alternatives
		...
		for(int count = 0;  count < repeat; count++) {
			...
			//KTUnknownVariance y = new KTUnknownVariance(alpha, delta, mu, sigma2,seedInOneReplication,n0,n0Prime);
			...
			//System.out.println("Replication: "+count+" "+y.getBestID()+" "+y.getTotalMatches()+" "+y.getSampleSize()+" "+y.getMaxRound()+" "+y.getRoundToSelectRef());
			System.out.println("Replication: "+count+" "+y.getBestID()+" "+y.getTotalMatches()+" "+y.getSampleSize()+" "+y.getMaxRound()+" "+y.getRoundToSelectRef()+" "+y.getPA()+" "+y.getPB()+" "+y.getSurAltRound1());
