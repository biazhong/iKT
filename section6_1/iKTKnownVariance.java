...
public class iKTKnownVariance {
	...
	public iKTKnownVariance(double alpha, double delta, ArrayList<Double> mu, ArrayList<Double> sigma2, int seed,int n0) {
		this.alpha = alpha;
		this.delta = delta;
		this.mu.addAll(mu);
