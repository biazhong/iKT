...
public class mainIdentifyTrueBestTL {
	public static void main(String[] args) throws FileNotFoundException{
		...
		int seed =   633212; //Pseudo random number seed used to conduct the experiment.
		double muCall = 6d/60;
		...
		for(int count = 0; count<repeat; count++) {
			...
			System.out.println(count*1.0/repeat);
		}
		String outputString = "";
		for(int s = 0;s <numOfAlt;s++) {
		...
		try (PrintWriter out = new PrintWriter("/home/ying/Desktop/Output.txt")) {
