...
public class iKT_INI_STAGE_CRN{
    int seed = 1374;
    int n0Frak;
    ...
    public iKT_INI_STAGE_CRN(double muCall, double muServe1, double muServe2,int coreID, int nCores, int seed, int n0Frak) {
    ...
    public void run() {
        ...
        for(int i = 0 ; i < k; i++) {
            for(int j = 0 ; j < n0Frak; j ++) {
                ...
                genTruckObv genObv = new genTruckObv(muCall,muServe1,muServe2,(int)(seed+j));
