...
public class iKTTruckCRN {
    ...
    public iKTTruckCRN(double alpha, double delta,int seed,int n0,int round,int coreID,int nCores,double muCall,
    ...
    public void run() {
        ...
        for(int i = 0; i < numOfMatches; i++) {
            if(i < numOfMatches - 1 ||(i == numOfMatches && numOfMatches==(Is.size()-1)*1.0/2.0)) {
                ...
                //}
                //refSamples.clear();
                KNTruckCRN y = new KNTruckCRN(muCall,muServe1,muServe2,alpha,round,delta,groupAltVec,seed*round,n0,refSamples);
                //	y.setRefSamples();
                y.run();
