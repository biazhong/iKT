...
public class genTruckObv {
    ...
    public void run() {
        ...
        int numOfTruck = 15;
        double[][] truck = new double[numOfTruck][3]; //0: Next Available Time; 1 for yes 0 for no; 1: x coordinate of the ambulance; 2: y coordinate of the ambulance.
        ...
        while(latestCallTime <= 12) {
            ...
            double[] distance = new double[numOfTruck];
            for (int _x = 0; _x < numOfTruck; _x++){
                distance[_x] = 100000d;
            }
