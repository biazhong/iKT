...
object iKTMain {
  def INI_Sampling(muCall:Double,muServe1:Double,muServe2:Double,
    ...
    val y = new iKT_INI_STAGE(muCall,muServe1,muServe2,CoreID,leftAlt,seed+CoreID,n0Frak);
  ...
  def withinCoreSelection(alpha:Double,delta:Double,seed:Int,n0:Int,round:Int,coreID:Int,
    ...
    val y = new iKTTruck(alpha,delta,seed+coreID,n0,round,coreID,nCores,muCall,muServe1,muServe2,I);
    y.run();
  ...
  def finalSelection(muCall:Double,muServe1:Double,muServe2:Double,alpha:Double,delta:Double
    ...
    println(altID(coreID)+" "+rinottSelection.getSampleAVG);
