...
public class KNTruck {
	...
	public KNTruck(double muCall, double muServe1,double muServe2,
	...
	public void run() {
		...
		Ref.setSeed((long)round+2342342);
		
		
		genTruckObv genObv = new genTruckObv(muCall,muServe1,muServe2,R.nextInt());
		
		
		genTruckObv genObvRef = new genTruckObv(muCall,muServe1,muServe2,Ref.nextInt());
